...
export interface DialogChildProps extends DialogProps {
  getOpenCount: () => number;
...
class Dialog extends React.Component<DialogChildProps, any> {
  static defaultProps = {
    className: '',
    mask: true,
    visible: false,
  ...
  render() {
    const { props } = this;
    const { prefixCls, maskClosable, center } = props;
